...
const PromoteScreen = ({ navigation, route }) => {
  const [{ auth_token, config, appSettings, user }, dispatch] = useStateValue();
                    ...
                    <View style={styles.tableHeader}>
                      <View style={styles.tableHeaderContentWrap}>
                        <View style={styles.tableHeaderContentInner}>
                          <Text style={styles.tableHeaderContent}>
                            {__(
                    ...
                    {plans.map((item, index, arr) => (
                      ...
                      >
                        <View style={styles.promotionCardWrap}>
                          ...
                          <View style={styles.promotionCardRowWrap}>
                            <View
                              style={{
                                flex: 3,
                                alignItems: "flex-start",
                            ...
                            >
                              <View style={styles.titleWrap}>
                                ...
                                >
                                  <Text style={styles.promotionCardTitle}>
